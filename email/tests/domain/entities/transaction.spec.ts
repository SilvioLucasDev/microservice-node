...
describe('TransactionEntity', () => {
  ...
  describe('create', () => {
    it('should create a TransactionEntity instance with correct values', () => {
    ...
    it('should rethrow PaymentTypeInvalidError for invalid paymentType', () => {
  ...
  describe('update', () => {
    it('should update the TransactionEntity instance with new values', () => {
    ...
    it('should rethrow TransactionStatusInvalidError for invalid status', () => {
